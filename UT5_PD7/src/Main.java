...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String[] lineas = ManejadorArchivosGenerico.leerArchivo("UT5_PD7\\src\\abonados.txt");
        ...
        String[] codigos = ManejadorArchivosGenerico.leerArchivo("UT5_PD7\\src\\codigos1.txt");
